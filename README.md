...
|:----------|:------------|
| 🖥️ **Virtualización** | ![VMware](https://img.shields.io/badge/VMware-607078?style=flat-square&logo=vmware&logoColor=white) ![vSphere](https://img.shields.io/badge/vSphere-607078?style=flat-square&logo=vmware&logoColor=white) ![ESXi](https://img.shields.io/badge/ESXi-607078?style=flat-square&logo=vmware&logoColor=white) ![Proxmox](https://img.shields.io/badge/Proxmox-E57000?style=flat-square&logo=proxmox&logoColor=white) ![VirtualBox](https://img.shields.io/badge/VirtualBox-183A61?style=flat-square&logo=virtualbox&logoColor=white) ![Citrix](https://img.shields.io/badge/Citrix-452170?style=flat-square&logo=citrix&logoColor=white) |
...
```ascii
  ╔══════════════════════════════════════════════════════╗
  ║  📚  Segundo cerebro en Obsidian — todo documentado  ║
  ║  🏠  Homelab sobre Raspberry Pi 5 (cluster 3 nodos)  ║
  ║  🧩  Automatización con agentes de IA (Hermes Agent) ║
  ║  ⚽  Prode Mundial 2026 — porque sí, también sé de   ║
  ║      fútbol (y quiero ganar)                         ║
  ║  🌙  Noctámbulo — mejores ideas después de las 2am   ║
  ╚══════════════════════════════════════════════════════╝
```
...
| Componente | Detalle |
|:-----------|:--------|
| 🖥️ **PC Personal** | Windows + Tailscale + Obsidian |
| 📱 **Celular** | Android — acceso remoto al homelab |
| 🍓 **Homelab** | 3× Raspberry Pi 5 + Proxmox cluster |
| 💾 **NAS** | OpenMediaVault — backups automáticos |
| 🌐 **Red** | MikroTik + Pi-hole + Tailscale mesh |
| 🤖 **Agente** | Hermes Agent — automatización con IA |
